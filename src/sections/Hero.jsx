...
function Hero() {
    return (
        <section className="w-full   md:min-h-screen align-center justify-center font-sans text-center">
            ...
            <div className='md:my-0 mb-8 w-[90vw] border-2 border-black rounded-xl shadow-xl px-2 flex flex-col  justify-center  text-center m-auto'>
