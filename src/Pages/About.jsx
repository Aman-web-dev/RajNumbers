  ...
  return (
    <div className='bg-[#ebece7] '>
      ...
      <div className='text-center ' id='heading '>
        <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl ">About Raj Vip Numbers</h1>
      ...
      <div id='w-[]' className='bg-[#454c5c] text-white mx-auto text-lg font-bold'>
        ...
        <div className='text-center' id='heading mt-8'>
          <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight  md:text-5xl lg:text-6xl ">About The Founder</h1>
        </div>
